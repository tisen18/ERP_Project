                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/employe/tambah"><button type="button" class="btn btn-primary">Tambah
                                            Karyawan</button></a>
                                        ...
                                        <tbody>
                                            @foreach ($employe as $employe)
                                                <tr>
                                                    ...
                                                    <td>{{ $employe->nama }}</td>
                                                    <td>{{ $employe->kontak }}</td>
                                                    <td>{{ $employe->alamat }}</td>
                                                    <td>{{ $employe->jabatan }}</td>
                                                    <td>{{ $employe->departemen }}</td>
                                                    <td>
                                                        <a href="{{ url('employe/edit/' . $employe->id) }}"><span
                                                                class="badge bg-success text-white"> Edit</span></a>
                                                        <a href="{{ url('employe/delete/' . $employe->id) }}"><span
