                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Vendor</h5>
                              <a href="vendor/tambah"><button type="button" class="btn btn-primary">Tambah
                                Vendor</button></a>
                            ...
                            <tbody>
                                @foreach ($vendor as $vnd)
                                    <tr>
                                        ...
                                        <td>{{ $vnd->alamat }}</td>
                                        <td>
                                            {{-- <a href="vendor/edit/{{ $vnd->id }}">Edit  |</a>
                                            <a href="vendor/delete/{{ $vnd->id }}">Hapus</a> --}}
                                            <a href="{{ url('vendor/edit/' . $vnd->id) }}"><span
                                                class="badge bg-success text-white"> Edit</span></a>
                                            <a href="{{ url('vendor/delete/' . $vnd->id) }}"><span
