        ...
        <div class="page-wrapper">
                        ...
                        <div class="search-form">
                            <form action="" method="get">
                                <div class="input-group input-group-sm" id="input-group-search">
                                    <input type="text" autocomplete="off" name="cari" id="cari"
                                        class="form-control" placeholder="Search..." value="$request-cari" />
            ...
            <div class="content-wrapper mt-n5">
                <div class="content"><!-- For Components documentaion -->
                    ...
                    {{-- <div class="card-body"> --}}
                        <a href="input-produk"><button type="button" class="btn btn-primary">Tambah Produk</button></a>
                        <a href="cetak-produk" target="_blank"><button type="button"class="btn btn-secondary">Cetak Produk</button></a>
                    ...
                    <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Internal References</th>
                                ...
                                @foreach ($produk as $pdk)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('home/produk/edit/' . $pdk->id) }}"><span
                                                class="badge bg-success text-white"> Edit</span></a>
                                            <a href="{{ url('home/produk/delete/' . $pdk->id) }}"><span
