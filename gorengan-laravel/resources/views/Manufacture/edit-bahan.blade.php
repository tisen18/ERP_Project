                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Edit Bahan Baku</h5>
                    <form action="{{ url('/home/bahan/update/'.$bahan->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          <label for="inputText" class="col-sm-2 col-form-label">Internal References</label>
                          <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label for="inputText" class="col-sm-2 col-form-label">Stok Produk</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="file" name="gambar" id="gambar" class="form-control" value="{{ asset('/img_bahan/'.$bahan->gambar) }}" style="max-width: 5rem;">
                          </div>
                        </div>
                        <div class="col-12">
