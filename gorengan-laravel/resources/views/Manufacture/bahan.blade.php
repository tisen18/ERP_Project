                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="vendor" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a class="sidenav-item-link" href=/vendor/vendor_tambah>
                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Bahan Baku</h5>
                            ...
                            <tbody>
                                @foreach ($bahan as $bhn)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('home/bahan/edit/' . $bhn->id) }}"><span
                                                class="badge bg-success text-white"> Edit</span></a>
                                            <a href="{{ url('home/bahan/delete/' . $bhn->id) }}"><span
