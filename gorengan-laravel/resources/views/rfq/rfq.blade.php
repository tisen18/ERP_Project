                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Request for Quotation</h5>
                            ...
                            @if ($rfqs->count())
                                @foreach ($rfqs as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->status == 1)
                                                <span class="badge bg-primary text-white">Draft</span>
                                            @elseif($item->status > 1)
                                                <span class="badge bg-secondary text-white">Purchase Order</span>
                                            @endif
                                        </td>
