                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Purchase Order Input Item</h5>
                                    <form action="{{ url('rfq-input-item') }}" method="post"
                                        enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row mb-3">
                                            <label for="inputText" class="col-sm-2 col-form-label">Kode RFQ</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="kode_rfq" id="kode_rfq"
                                                    class="form-control" value="{{ $rfq->kode_rfq }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="nama" id="nama"
                                                    class="form-control" value="{{ $rfq->nama }}" disabled>
                                            </div>
                                        </div>
                                        @if ($rfq->status == 1)
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <label for="inputText"
                                                    class="col-sm-2 col-form-label">Kuantitas</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="col-12">
                                                <button class="btn btn-primary w-100" type="submit"
                                                    name="simpan">Tambah Bahan</button>
                                            </div>
                                        @endif
                                            ...
                                            @if ($rfqList->count())
                                                @foreach ($rfqList as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('rfq-delete-item/' . $item->kode_rfq_list) }}"><span
                                                                    class="badge bg-success"> Hapus</span></a>
                                                        </td>
                                                    @else
                                                        <td>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    @if ($rfq->status == 1)
                                        <form action="{{ url('po/savePo') }}" method="post" class="btn p-0"
                                            name="input-form" id="input-form">
                                            {{ csrf_field() }}
                                            <input type="text" id="kode_rfq" value="{{ $rfq->kode_rfq }}"
                                                name="kode_rfq" hidden>
                                            <button type="submit" onclick="return confirm('Confirm Order?');"
                                                class="btn btn-success">Confirm Order</button>
                                        </form>
                                    @elseif($rfq->status == 2)
                                        <form action="{{ url('po/savePo') }}" method="post" class="btn p-0"
                                            name="input-form" id="input-form">
                                            ...
                                            <input type="text" id="kode_rfq" value="{{ $rfq->kode_rfq }}"
                                                name="kode_rfq" hidden>
                                            <button type="submit" onclick="return confirm('Receive Product?');"
                                                class="btn btn-success">Receive Product</button>
                                        </form>
                                    @elseif($rfq->status == 3)
                                        <form action="{{ url('po/savePo') }}" method="post" class="btn p-0"
                                            name="input-form" id="input-form">
                                            ...
                                            <input type="text" id="kode_rfq" value="{{ $rfq->kode_rfq }}"
                                                name="kode_rfq" hidden>
                                            <button type="submit" onclick="return confirm('Validate?');"
                                                class="btn btn-success">Validate</button>
                                        </form>
                                    @elseif($rfq->status == 4)
                                        <form action="{{ url('po/create-bill') }}" method="post" class="p-0"
                                            name="input-form" id="input-form">
                                            {{ csrf_field() }}
                                            <label for="inputText" class="col-form-label">Pilih Metode
                                                Pembayaran:</label>
                                            <fieldset class="row mb-3">
                                                <div class="col-sm-10">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="payment"
                                                            id="payment" value="1" checked>
                                            ...
                                            <input type="text" id="kode_rfq" value="{{ $rfq->kode_rfq }}"
                                                name="kode_rfq" hidden>
                                            <button type="submit" onclick="return confirm('Create Bill?');"
                                                class="btn btn-success">Create Bill</button>
                                        </form>
                                    @elseif($rfq->status == 5)
                                        <label>Metode Pembayaran :
                                            <span class="badge bg-success">
                                                {{ $rfq->metode_pembayaran == 1 ? 'Cash' : 'Transfer' }}</span>
                                        </label><br>
                                        <label>Status Pembayaran : <span class="badge bg-success">Fully
                                                Billed</span></label><br>
                                        <br>
                                        <button type="submit" class="btn btn-dark"><a
                                                href="{{ url('po-invoice/' . $rfq->kode_rfq) }}" target="_blank"
                                                class="text-white">Lihat Invoice</a></button>
                                    @endif
                                </div>
                            </div>
                        </div>
