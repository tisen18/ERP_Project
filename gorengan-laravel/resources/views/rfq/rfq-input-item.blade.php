                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Request for Quotation Input Item</h5>
                    <form action="{{ url('rfq-input-item')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <select class="form-control" aria-label="Default select example" name="kode_bahan" id="kode_bahan">
                        ...
                        <tbody>
                          ...
                          @foreach($rfqList as $item)
                            <tr>
                              ...
                              @if($rfq->status == 1)
                              <td>
                                  <a href="{{ url('rfq-delete-item/'.$item->kode_rfq_list) }}"><span class="badge bg-success text-white"> Hapus</span></a>
                              </td>
                              @else
                                <td>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Edit Status Request For Quotation</h5>
                        <form action="{{ url('rfq/save') }}" method="post" class="btn p-0" name="input-form" id="input-form">
                            {{ csrf_field() }}
