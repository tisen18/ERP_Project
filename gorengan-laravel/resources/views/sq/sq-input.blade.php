                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Sales Quotation Input</h5>
                    <form action="{{ url('/sq-input')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <select class="form-control" aria-label="Default select example" name="kode_customer" id="kode_customer">
