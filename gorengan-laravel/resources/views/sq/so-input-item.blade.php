                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Sales Order Input Item</h5>
                    <form action="{{ url('sq-input-item')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <select class="form-control" aria-label="Default select example" name="kode_produk" id="kode_produk">
                        ...
                        <tbody>
                          ...
                          @foreach($sqList as $item)
                            <tr>
                              ...
                              @if($sq->status == 1)
                              <td>
                                  <a href="{{ url('sq-delete-item/'.$item->kode_sq_list) }}"><span class="badge bg-success"> Hapus</span></a>
                              </td>
                              @else
                                <td>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      @endif
                        @if($sq->status == 1 )
                        <form action="{{ url('sq/saveSo') }}" method="post" class="btn p-0" name="input-form" id="input-form">
                            {{ csrf_field() }}
                        ...
                        @elseif($sq->status == 2 )
                        <form action="{{ url('sq/invoice') }}" method="post" class="btn p-0" name="input-form" id="input-form">
                            {{ csrf_field() }}
                        ...
                        <button type="submit" class="btn btn-dark"><a href="{{ url('so-invoice/'.$sq->kode_sq) }}" target="_blank" class="text-white">Lihat Invoice</a></button>
                        @elseif($sq->status == 4)
                        <form action="{{ url('sq/delivery') }}" method="post" class="btn p-0" name="input-form" id="input-form">
                            {{ csrf_field() }}
                            <input type="text" id="kode_sq" value="{{$sq->kode_sq}}" name="kode_sq" hidden>
