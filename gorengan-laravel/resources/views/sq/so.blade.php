                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Sales Order</h5>
                        ...
                        <tbody>
                          ...
                          @if($item->status >1)
                            <tr>
                              ...
                              <td>
                                <a href="{{ url('so-input-item/'.$item->kode_sq) }}"><span class="badge bg-success text-white"> Edit</span></a>
                                @if($item->status >= 3 )
                                <a href="{{ url('so-invoice/'.$item->kode_sq) }}" target="_blank"><span class="badge bg-info text-white"> Invoice</span></a>
                                @endif
                              </td>
                            </tr>
                          @endif
