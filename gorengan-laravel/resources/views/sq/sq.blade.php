                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Sales Quotation</h5>
                              <a href="sq-input"><button type="button" class="btn btn-primary">Tambah Sales Quotation</button></a>
                          ...
                          @foreach($sqs as $item)
                            <tr>
                              ...
                              <td>
                                ...
                                <span class="badge bg-secondary text-white">Sales Orders</span>
                                @endif
                              </td>
                              <td>{{$item->total_harga}}</td>
                              <td>
                                <a href="{{ url('sq-input-item/'.$item->kode_sq) }}"><span class="badge bg-success text-white"> Edit</span></a>
                                <a href="{{ url('sq-delete/'.$item->kode_sq) }}"><span class="badge bg-danger text-white"> Hapus</span></a>
                              </td>
                            </tr>
                          @endforeach
                          @else
