            ...
            <div id="sidebar" class="sidebar sidebar-with-footer">
                ...
                <div class="sidebar-left" data-simplebar style="height: 100%;">
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#sales" aria-expanded="false" aria-controls="employe">
                            <i class="mdi mdi-sales"></i>
                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Bill of Material</h5>
                    {{-- <div class="card-body"> --}}
                        <a href="input-bom"><button type="button" class="btn btn-primary">Tambah BoM</button></a>
                        <a href="cetak-bom" target="_blank"><button type="button" class="btn btn-secondary">Cetak BoM</button></a>
