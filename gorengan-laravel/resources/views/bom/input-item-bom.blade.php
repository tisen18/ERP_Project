                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('bom/input-item-bom') }}" method="post"
                                        enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row mb-3">
                                            <label for="inputText" class="col-sm-2 col-form-label">Kode BOM</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="kode_bom" id="kode_bom"
                                                    class="form-control" value="{{ $bom->kode_bom }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="nama" id="nama"
                                                    class="form-control" value="{{ $bom->nama }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit"
                                                name="simpan">Insert</button>
                                        </div>
                                    </form><!-- End General Form Elements -->
                                    <br>
                                    <div class="col-12"><a href="/bom/bom">
                                        <button class="btn btn-primary w-100" type="submit"
                                            ...
                                            @if ($list->count())
                                                @foreach ($list as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a
                                                                href="{{ url('bom/bom-delete-item/' .$item->kode_bom_list) }}"><span
                                                                    class="badge bg-success text text-white">Hapus</span></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
        ...
        function updateSubTotal() {
            ...
            if (table) {
                let subTotal = Array.from(table.rows).slice(1).reduce((total, row) => {
                    ...
                    return total; // Skip rows that don't have enough cells.
                }, 0);
