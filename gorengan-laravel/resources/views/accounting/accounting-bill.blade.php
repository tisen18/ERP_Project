                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    {{-- <a href="/accounting-bill"><button type="button"
                                            class="btn btn-success">Tampilkan Semua Data</button></a> --}}
                                    <a href="/accounting-bill/cetak/" target="_blank"><button type="button"
                                            class="btn btn-primary">Cetak Laporan</button></a>
                                    {{-- <a href="" onclick="this.href='/accounting-bill/cetak-pertanggal/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value" target="_blank" class="btn btn-secondary">Cetak Laporan Per Tanggal</a> --}}
                                    
                                    {{-- <h5 class="card-title m-2">Filter Berdasarkan Tanggal</h5> --}}
                                    <div class="card-body p-2">
                                        {{-- <div class="row mb-10">
                                            <label for="inputDate" class="col-sm-2 m-2">Tanggal
                                                Awal</label>
                                            <input type="date" class="form-control" name="tglawal"
                                                id="tglawal">
                                            <label for="inputDate" class="col-sm-7 m-2">Tanggal
                                                Akhir</label>
                                            <input type="date" class="form-control" name="tglakhir"
                                                id="tglakhir">
                                            <div class="p-2">
                                                <a href=""
                                                    onclick="this.href='/accounting-bill/tampil-pertanggal/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"
                                                    class="btn btn-secondary">Tampilkan Data Per Tanggal</a>
                                            </div>
                                        </div> --}}
                                                    ...
                                                    @if ($item->status > 4)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($item->status == 1)
                                                                    <span
                                                                        class="badge bg-primary text-white">Draft</span>
                                                                @elseif($item->status == 2)
                                                                    <span
                                                                        class="badge bg-secondary text-white">Purchase
                                                                        Order</span>
                                                                @elseif($item->status == 3)
                                                                    <span class="badge bg-warning text-white">Nothing
                                                                        to
                                                                        Bill</span>
                                                                @elseif($item->status == 4)
                                                                    <span class="badge bg-info text-white">Waiting to
                                                                        Bill</span>
                                                                @elseif($item->status == 5)
                                                                    <span class="badge bg-success text-white">Fully
                                                                        Billed</span>
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @elseif($item->metode_pembayaran == 1)
                                                                    <span
                                                                        class="badge bg-primary text-white">Cash</span>
                                                                @elseif($item->metode_pembayaran == 2)
                                                                    <span
                                                                        class="badge bg-primary text-white">Transfer</span>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                @if ($item->status >= 5)
                                                                    <a href="{{ url('po-invoice/' . $item->kode_rfq) }}"
                                                                        target="_blank"><span
                                                                            class="badge bg-info text-white">Cek
                                                                            Invoice</span></a>
                                                                @endif
                                                            </td>
                                                        </tr>
