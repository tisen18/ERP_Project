                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="/accounting-invoicing/cetak/" target="_blank"><button type="button"
                                            class="btn btn-primary">Cetak Laporan</button></a>
                                    <div class="card-body p-2">
                                    </div>
                                    <table class="table datatable" id="myTable">
                                        {{-- <a href="/accounting-invoicing"><button type="button"
                                                            ...
                                                            @if ($item->status > 4)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if ($item->status == 1)
                                                                            <span
                                                                                class="badge bg-primary text-white">Quotation</span>
                                                                        @elseif($item->status == 2)
                                                                            <span
                                                                                class="badge bg-secondary text-white">To
                                                                                Invoice</span>
                                                                        @elseif($item->status == 3)
                                                                            <span
                                                                                class="badge bg-warning text-white">Draft
                                                                                Invoice</span>
                                                                        @elseif($item->status == 4)
                                                                            <span
                                                                                class="badge bg-info text-white">Fully
                                                                                Invoiced</span>
                                                                        @elseif($item->status == 5)
                                                                            <span
                                                                                class="badge bg-success text-white">Delivered</span>
                                                                        @endif
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        @if ($item->status >= 3)
                                                                            <a href="{{ url('so-invoice/' . $item->kode_sq) }}"
                                                                                target="_blank"><span
