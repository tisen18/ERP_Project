                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Manufacturing Order Check Avaibility</h5>
                    <form action="{{ url('Manufacture/bom-input-item')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                        ...
                        <tbody>
                          ...
                          @foreach($list as $item)
                            <tr>
                              ...
                              @if($item->stok < $total )
                              <td>
                                <a href="{{ url('rfq-input') }}" class="btn btn-danger delete-confirm"> Tambah Bahan</a>
                              </td>
                              @else
                              <td>
