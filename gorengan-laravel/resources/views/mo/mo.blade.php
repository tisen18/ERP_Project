                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Tabel Manufacturing Order</h5>
                              {{-- <div class="card-body"> --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($item->status == 2)
                                                <span class="badge bg-secondary text-white">Mark as Todo</span>
                                            @elseif($item->status == 3)
                                                <a href="{{ url('Manufacture/mo-ca/' . $item->kode_mo) }}"><span
                                                        class="badge bg-warning text-white">Check
                                                        Availability</span></a>
                                            @elseif($item->status == 4)
                                                <span class="badge bg-info text-white">Production</span>
