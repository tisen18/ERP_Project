                ...
                <div class="content"><!-- For Components documentaion -->
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Manufacturing Order Input</h5>
                                    <form action="{{ url('Manufacture/mo-input') }}" method="post"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="kode_mo" id="kode_mo"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        {{-- <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" aria-label="Default select example"
                                                    name="kode_bom" id="kode_bom">
                                                    <option selected>Pilih Produk</option>
                                                    @if ($tb_bom->count())
                                                        @foreach ($tb_bom as $item)
                                                            <option value="{{ $item->kode_bom }}">
                                                                {{ $item->kode_bom }} -
                                                                {{ $item->nama }} x {{ $item->kuantitas }} Pcs
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                </select>
