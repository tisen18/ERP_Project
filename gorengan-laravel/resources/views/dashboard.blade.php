                    ...
                    <div class="card-deck">
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Produk</h6>
                                <p class="card-text">Berisikan Data-data Produk.</p>
                                <a href="/Manufacture/produk" class="card-link">Tabel Produk</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Bahan Baku</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Bahan Baku</h6>
                                <p class="card-text">Berisikan Data-data Bahan Baku.</p>
                                <a href="Manufacture/bahan" class="card-link">Tabel Bahan Baku</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Bill Of Material</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Bill Of Material</h6>
                                <p class="card-text">Berisikan Data-data Pembuatan Produk dari Bahan.</p>
                                <a href="/bom/bom" class="card-link">Tabel Bill Of Material</a>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="card-deck">
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Manufacturing Order</h6>
                                <p class="card-text">Berisikan Proses Pembuatan Produk dari Bahan.</p>
                                <a href="/Manufacture/mo" class="card-link">Tabel Manufacturing Order</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Vendor</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Vendor</h6>
                                <p class="card-text">Berisikan Data-data Vendor.</p>
                                <a href="/vendor" class="card-link">Tabel Vendor</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Request For Quotation</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel RFQ</h6>
                                <p class="card-text">Berisikan Data-Data Request For Quotation.</p>
                                <a href="/rfq" class="card-link">Tabel Request For Quotation</a>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="card-deck">
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Pesanan Pembelian</h6>
                                <p class="card-text">Berisikan data-data pesanan pembelian.</p>
                                <a href="/po" class="card-link">Tabel Purchase Order</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Customer</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Pelanggan</h6>
                                <p class="card-text">Berisikan data-data pelanggan.</p>
                                <a href="/customer" class="card-link">Tabel Customer</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Sales Quotation</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Penawaran</h6>
                                <p class="card-text">Berisikan data-data penawaran penjualan.</p>
                                <a href="/sq" class="card-link">Tabel Sales Quotation</a>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="card-deck">
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Penjualan</h6>
                                <p class="card-text">Berisikan data-data transaksi penjualan.</p>
                                <a href="/so" class="card-link">Tabel Sales Order</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Accounting Invoicing</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Pembelian Konsumen</h6>
                                <p class="card-text">Berisikan list data penjualan yang di beli konsumen.</p>
                                <a href="/accounting-invoicing" class="card-link">Tabel Accounting Invoicing</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Accounting Vendor</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Pemeblian Vendor</h6>
                                <p class="card-text">Berisikan list data pembelian yang di beli dari vendor.</p>
                                <a href="/accounting-bill" class="card-link">Tabel Accounting Vendor</a>
                            </div>
                        </div>
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                <h5 class="card-title">Employe</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Tabel Karyawan</h6>
                                <p class="card-text">Berisikan data-data karyawan.</p>
                                <a href="/employe" class="card-link">Tabel Employe</a>
                            </div>
                        </div>
                    </div>
                    <br>
